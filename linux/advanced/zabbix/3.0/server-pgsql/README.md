...
ZBX_LISTENIP=
ZBX_HISTORYSTORAGEURL= # Available since 3.3.0
ZBX_HISTORYSTORAGETYPES=uint,dbl,str,log,text # Available since 3.3.0
ZBX_STARTPOLLERS=5
ZBX_IPMIPOLLERS=0
ZBX_STARTPREPROCESSORS=3 # Available since 3.3.0
...
ZBX_STARTALERTERS=3 # Available since 3.3.0
ZBX_JAVAGATEWAY=zabbix-java-gateway
ZBX_JAVAGATEWAYPORT=10052
ZBX_STARTJAVAPOLLERS=5
ZBX_STARTLLDPROCESSORS=2 # Available since 4.2.0
ZBX_STATSALLOWEDIP= # Available since 3.0.5
...
ZBX_EXPORTFILESIZE=1G # Available since 3.0.0
ZBX_HISTORYCACHESIZE=16M
ZBX_HISTORYINDEXCACHESIZE=4M
ZBX_HISTORYSTORAGEDATEINDEX=0 # Available since 3.0.0
